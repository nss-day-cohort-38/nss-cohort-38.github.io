              ...
              <div className="student-card">
                ...
                <div className="card-content">
                    <div className="card-fx">
                      {/* <picture> */}
                      <img id="card-student-photo" src={require(`../../images/students/${this.props.student.proImg}`)} alt="student-serious-photo" className="student-serious-photo"/>
                      <img id="card-student-photo" src={require(`../../images/students/${this.props.student.funImg}`)} className="student-fun-photo" />
                      {/* </picture> */}
                    </div>
